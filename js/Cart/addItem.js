// import { cartItemsInfo } from "./cartItemInfo.js"

// let items = document.querySelector('#itemsCart')
// let item = document.createElement('div')


// function addItem() {
// 	cartItemsInfo.forEach(itemInfo => {
...
// 				<h2 class="title">${itemInfo.title}</h2>
// 				<div class="ranked">
...
// 						<h4 class="number" id="sum">${itemInfo.sum + +localStorage.getItem('count')} </h4>
// 						<button id="btnPlus" data-action="plus">+</button>
// 					</div>
// 					<div class="price__text">
// 						<h2 class="subject">${itemInfo.price}₽</h2>
// 						<s>${itemInfo.pastPrice} </s>
// 					</div>
// 				</div>
// 			</div>
// 			<div class="item-info">
